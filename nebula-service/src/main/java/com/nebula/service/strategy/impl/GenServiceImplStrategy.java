...
@Strategy(CodeGenTypeConstants.SERVICE_IMPL)
public class GenServiceImplStrategy implements CodeGenStrategy {
    ...
    public void genFile(String codeContext, String className, String path) {
        File file = new File(path+File.separator+className+"ServiceImpl.java");
