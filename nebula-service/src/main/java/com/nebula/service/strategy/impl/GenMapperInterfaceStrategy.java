...
@Strategy(CodeGenTypeConstants.MAPPER_INTERFACE)
public class GenMapperInterfaceStrategy implements CodeGenStrategy {
    @Autowired
    VelocityEngine velocityEngine;
    @Override
    public String genCode(Map<String, Object> params) {
        String templateName = "MapperInterface.vm";
    ...
    public void genFile(String codeContext, String className, String path) {
        File file = new File(path+File.separator+className+"Mapper.java");
