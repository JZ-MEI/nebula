...
@Strategy(CodeGenTypeConstants.SERVICE)
public class GenServiceStrategy implements CodeGenStrategy {
    @Autowired
    ...
    public void genFile(String codeContext, String className, String path) {
        File file = new File(path+File.separator+className+"Service.java");
